"""
Django settings for multi_mart project.
...
SECRET_KEY = 'django-insecure-yq*&ntqpohn5cs$!x1^=x)lnen^b__mu7@!loh$*n(aekr06s3'
...
WSGI_APPLICATION = 'multi_mart.wsgi.application'
